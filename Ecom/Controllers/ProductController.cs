...
{
    //public class ProductController : GenericController<ProductController>
    //{
    //    public ProductController(IUnitOfWork uow, ILoggerFactory logger, IMapper mapper) : base(uow, logger, mapper)
    //    {
    //    }
    ...
    //    {
    //        if (id == null || UOW.Products == null)
    //        {
    //            return NotFound();
    //        }

    //        var product = await UOW.Products.Get(id);
    //            //.Include(p => p.Category)
    //            //.Include(p => p.Seller)
